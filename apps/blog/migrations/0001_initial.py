# Generated by Django 2.0.3 on 2019-06-26 04:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(default='/static/images/summary.jpg', upload_to='media')),
                ('slug', models.SlugField(editable=False)),
                ('is_top', models.BooleanField(default=False, verbose_name='是否首页展示')),
                ('author', models.ForeignKey(default='2', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='作者')),
            ],
            options={
                'verbose_name': '文章',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(default='/static/images/summary.jpg', null=True, upload_to='media')),
            ],
            options={
                'verbose_name': '图片轮播',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='娃哈哈店长的个人网站，记录生活的瞬间，分享学习的心得，感悟生活，留住感动，静静寻觅生活的美好', help_text='用来作为SEO中description,长度参考SEO标准', max_length=240, verbose_name='描述')),
            ],
            options={
                'verbose_name': '分类',
