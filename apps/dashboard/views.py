...
@require_http_methods('dashboard/indicator', methods=['GET'], jwt_required=True)
...
@require_http_methods('dashboard/kpi_value', methods=['POST'], jwt_required=True)
...
@require_http_methods('transaction/list', methods=['GET'], jwt_required=True)
