...
apps_floder = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'apps')
apps = ['apps.'+_ for _ in os.listdir(apps_floder) if os.path.isdir(os.path.join(apps_floder, _)) and 'pycache' not in _]
INSTALLED_APPS += apps
